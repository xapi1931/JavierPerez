...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
	...
	<form:form class="form-signin" modelAttribute="cliente" method="POST" action="../login/cliente">
		<p><spring:message code="request.login.client"/></p>
	...
	<br>
	${msg}
	<a href="../login/abogado"><spring:message code="acceso.abogado"/></a>
